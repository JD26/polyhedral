...
$S^{d-1}=\left\{ x\in\mathbb{R}^{d}\mid\left\Vert x\right\Vert =1\right\} $
is the unit $\left(d-1\right)$-sphere.
...
are arbitrary $C^{\infty}$ functions.
\end{defn}
%
\begin{defn}
...
\end{defn}
\begin{thm}
There exist $\tau>0$ and a $C^{\infty}$ mapping $T:\overline{\Omega}\times\left(-\tau,\tau\right)\rightarrow\mathbb{R}^{d}$
